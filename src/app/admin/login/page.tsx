...
export default function AdminLogin() {
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            if (email === 'admin@admin.com.br' && password === 'Meusaas2811') {
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    required
                                    className="w-full bg-white/5 border border-white/10 focus:border-primary focus:ring-1 focus:ring-primary rounded-xl py-3.5 pl-12 pr-4 text-slate-200 text-sm outline-none transition-all placeholder:text-slate-600 font-mono tracking-widest"
                                />
                            </div>
                        </div>
